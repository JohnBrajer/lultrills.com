...
export function identityBlock(): string {
  return [
    ...
    "ARTIST_IDENTITY: John B · FOUNDER_ARCHITECT: John Brajer · MEDIA_CULTURE_IDENTITY: John Braj · SYSTEM: Trillsverse · OPERATOR: Trillsverse LLC",
    ...
    "FRAMING: Trillsverse is the reality update. Music as documentation. Gate as runtime. Canon as memory.",
    "ONTOLOGY: Lultrills, John B, Ace Brajer, and Kasano are currently known named Fragments/nodes; the known set is not exhaustive. John B is the music and artist identity. John Brajer is founder and architect. John Braj is the personality/media/culture identity.",
    ...
    "REALITY_UPDATE: Trillsverse is the reality update.",
