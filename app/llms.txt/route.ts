...
- [Architecture](${base}/architecture): Dual-domain technical record · Canon vs Gate · evidence links
- [Machine Entry](${base}/machine-entry): First hop for agents · corpus orientation
